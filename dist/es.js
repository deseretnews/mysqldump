...
// eslint-disable-next-line complexity
function getDataDump(connectionOptions, options, tables, dumpToFile, dumpToStream) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let outFileStream = null;
        if (dumpToFile) {
            outFileStream = createWriteStream(dumpToFile, {
                flags: 'a',
                encoding: 'utf8',
            });
        }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (options.dump.data !== false) {
                ...
                const tables = res.tables;
                res.tables = yield getDataDump(options.connection, options.dump.data, tables, options.dumpToFile, writeStream);
